...
if __name__=="__main__":
    ...
    eng_train = ConLLUParser('UD_English-EWT-master/en_ewt-ud-train.conllu', verbose)
    eng_dev = ConLLUParser('UD_English-EWT-master/en_ewt-ud-dev.conllu', verbose)
    eng_test = ConLLUParser('UD_English-EWT-master/en_ewt-ud-test.conllu', verbose)

    fr_train = ConLLUParser('UD_French-GSD-master/fr_gsd-ud-train.conllu', verbose)
    fr_dev = ConLLUParser('UD_French-GSD-master/fr_gsd-ud-dev.conllu', verbose)
    fr_test = ConLLUParser('UD_French-GSD-master/fr_gsd-ud-test.conllu', verbose)

    fi_train = ConLLUParser('UD_Finnish-TDT-master/fi_tdt-ud-train.conllu', verbose)
    fi_dev = ConLLUParser('UD_Finnish-TDT-master/fi_tdt-ud-dev.conllu', verbose)
    fi_test = ConLLUParser('UD_Finnish-TDT-master/fi_tdt-ud-test.conllu', verbose)